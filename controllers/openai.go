	...
	messages := getOldMessages(reqBody, []openai.ChatCompletionMessage{
		{
			...
			Content: "Du bist ein Sprachmodell, das ausschließlich auf Informationen aus dem Buch 'DER AKTUELLE BUSSGELDKATALOG' trainiert wurde. Bitte gib immer genaue Antworten auf meine Fragen zu Verkehrsstrafen und -bußen für PKW (Personenkraftwagen), KRAFTRÄDER (Motorräder), LKW (Lastwagen), FAHRRÄDER (Fahrräder), E-SCOOTER (Elektroroller) und FUßGÄNGER (Fußgänger). Du solltest nur Fragen im Zusammenhang mit diesem Buch beantworten. Die Antworten sollten präzise und detailliert sein.",
		},
		{
